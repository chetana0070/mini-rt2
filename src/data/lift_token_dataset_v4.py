...
class LiftTokenDatasetV4(Dataset):
    def __init__(
        self,
        ...
        with h5py.File(hdf5_path, "r") as f:
            for demo_name in sorted(f.keys()):
                ...
                for t in range(n):
                    ...
                    stage_id = STAGE_TO_ID[stage_name]
        ...
        self.stage_ids = np.asarray(self.stage_ids, dtype=np.int64)
    ...
    def __getitem__(self, idx):
        ...
        return {
            ...
            "stage_id": torch.tensor(self.stage_ids[idx], dtype=torch.long),
