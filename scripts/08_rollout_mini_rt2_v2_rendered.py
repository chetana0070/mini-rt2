...
parser.add_argument("--ckpt", type=str, default="checkpoints/mini_rt2_v2_best.pt")
...
def main():
    ...
    print("Proprio dim:", proprio_dim)
    print("Camera keys:", camera_keys)
    print("Render:", render)
    print("GL:", args.gl)
    print("Demo len for timestep:", args.demo_len)
    ...
    for ep in range(args.episodes):
        ...
        for step in range(args.horizon):
            ...
            action = action_tokenizer.decode(pred_tokens)
            ...
            title = (
                f"Mini RT-2 v2 ep={ep} step={step} dz={lift_delta:.3f} "
            ...
            stop = show_camera_panel(
                ...
                window_name="Mini RT-2 v2 Rollout: agentview + frontview",
                title_text=title,
                delay=1,
            )
        ...
        video_path = f"videos/mini_rt2_v2_rollout_ep_{ep:04d}.mp4"
