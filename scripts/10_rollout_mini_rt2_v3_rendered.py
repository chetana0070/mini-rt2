...
def main():
    ...
    for ep in range(args.episodes):
        ...
        for step in range(args.horizon):
            ...
            title = (
                f"Mini RT-2 v3 ep={ep} step={step} dz={lift_delta:.3f} "
            ...
            stop = show_camera_panel(
                ...
                window_name="Mini RT-2 v3 Rollout: agentview + frontview",
                title_text=title,
                delay=1,
            )
        ...
        video_path = f"videos/mini_rt2_v3_rollout_ep_{ep:04d}.mp4"
